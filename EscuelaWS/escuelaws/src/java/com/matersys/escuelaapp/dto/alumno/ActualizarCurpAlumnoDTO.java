 ...
 * @author eiste
 */
public class ActualizarCurpAlumnoDTO implements java.io.Serializable {
    private CredencialesDTO cdto;
    private String curpAlumno;
    private String nuevoCurpAlumno;
    ...
    /**
     * @return the nuevoCurpAlumno
     */
    public String getNuevoCurpAlumno() {
        return nuevoCurpAlumno;
    }

    /**
     * @param nuevoCurpAlumno the nuevoCurpAlumno to set
     */
    public void setNuevoCurpAlumno(String nuevoCurpAlumno) {
        this.nuevoCurpAlumno = nuevoCurpAlumno;
    }
