...
public class Menus extends JPanel {
    static final Icon imagen = new ImageIcon("/home/aelias/Escritorio/descarga.jpeg");
  ...
  JLabel lbl = new JLabel( "Icono Seleccionado",JLabel.CENTER );
  ...
  public Object menuIconos[][] = {
    ...
    { "Icono 0",rb,new Character('0'),al2,bT,imagen },
    { "Icono 1",rb,new Character('1'),al2,bT,imagen },
    { "Icono 2",rb,new Character('2'),al2,bT,imagen },
    { "Icono 3",rb,new Character('3'),al2,bT,imagen },
    { "Icono 4",rb,new Character('4'),al2,bT,imagen },
  };
  ...
  public static void main(String args[]) {
    ...
    ventana.getContentPane().add( new Menus(),BorderLayout.CENTER );
